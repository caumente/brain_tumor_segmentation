...
class ShallowUNetNoPoolings(nn.Module):
    """
    ...
    def __init__(self, sequences, regions, width, deep_supervision):
        super(ShallowUNetNoPoolings, self).__init__()
...
def test():
    ...
    model = ShallowUNetNoPoolings(sequences=4, regions=3, width=24, deep_supervision=False)
