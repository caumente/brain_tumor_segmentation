...
from src.models.testing_models import models
from src.models.testing_models.models import CONFIGS as CONFIGS_ViT_seg
...
def main(args):
    ...
    model = models.ViTVNet(config_vit, img_size=(160, 224, 160))
    model = model.to(device)
